...
public class CustomScrollHandler extends RelativeLayout implements ScrollHandle {
    ...
    private final static int HANDLE_SHORT = 125;
    private final static int DEFAULT_TEXT_SIZE = 0;
    ...
    public void setupLayout(PDFView pdfView) {
        ...
        if (pdfView.isSwipeVertical()) {
            ...
            if (inverted) { // left
                ...
                background = ContextCompat.getDrawable(context, com.example.kuriotetsuya.pdf.R.drawable.ic_menu_black_24dp);
            } else { // right
